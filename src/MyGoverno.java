...
public class MyGoverno implements Governo {
    ...
    public MyGoverno(long risorse, int costo) {
        ...
        MyGoverno.risorse = risorse;
        MyGoverno.costo = costo;
    ...
    public static class Popolazione {
        ...
        public Popolazione(long numeroIndividui, int velocita) {
            ...
            Popolazione.velocita = velocita;
            Popolazione.numeroIndividui = numeroIndividui;
    ...
    public void isolamento(boolean isolati, long numeroIsolatiVerdi, long numeroIsolatiGialli) {
        ...
        try {
            // Se è comparso almeno un rosso
            if (inizioIsolamento) {
                // Condizione per mettere in isolamento
                if (isolati) {
                    // Controllo se si cerca di isolare un numero di persone disponibili
                ...
                } else { // Condizione per togliere dall'isolamento
